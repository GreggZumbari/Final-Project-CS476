...
msg::msg(const char *name, short kind) : ::omnetpp::cMessage(name, kind)
{
}

msg::msg(const msg& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
void msg::setDestination(int destination)
{
...
msgDescriptor::msgDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(msg)), "omnetpp::cMessage")
{
...
int msgDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    ...
    msg *pp = omnetpp::fromAnyPtr<msg>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
void msgDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    ...
    msg *pp = omnetpp::fromAnyPtr<msg>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'msg'", field);
    }
}
...
void msgDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'msg'", field);
    }
}
...
omnetpp::cValue msgDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'msg' as cValue -- field index out of range?", field);
    }
}
